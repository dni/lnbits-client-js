...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Lnbits.CreateLnurlAuth();
  });
  ...
  describe('CreateLnurlAuth', function() {
    it('should create an instance of CreateLnurlAuth', function() {
      // uncomment below and update the code to test CreateLnurlAuth
      //var instance = new Lnbits.CreateLnurlAuth();
      //expect(instance).to.be.a(Lnbits.CreateLnurlAuth);
    });
